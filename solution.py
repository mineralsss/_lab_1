...
def call_openai(
    ...
    response = client.chat.completions.create(messages=[{"role": "user", "content": prompt}], model=model, temperature=temperature, top_p=top_p, max_tokens=max_tokens)
...
def compare_models(prompt: str) -> dict:
    ...
    number_of_tokens = len(gpt4o_response.split()) / 0.75
    gpt4o_cost_estimate = (number_of_tokens / 1000) * COST_PER_1K_OUTPUT_TOKENS["gpt-4o"]
    return {
